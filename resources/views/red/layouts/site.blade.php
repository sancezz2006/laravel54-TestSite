            ...
            <div id="matrox-menu" class="menuzord">
                ...
                <ul class="menuzord-menu pull-right">
                        ...
                        <div class="megamenu">
                            <div class="megamenu-row">
                                ...
                                <div class="col3">
                                    <h2>Onepage Demo</h2>
                                    <ul class="list-unstyled clearfix">
                                        <li><a href="op-index-1.html" target="_blank">Matrox Onepage</a></li>
                    ...
                    <li class="active"><a href="javascript:void(0)">Blog</a>
                        <ul class="dropdown">
                            <li class="active"><a href="#">Standard</a>
                                <ul class="dropdown ">
                                    <li class="active"><a href="blog-sidebar-right.html">Sidebar Right</a></li>
                ...
                <div class="posts-content default-blog">
                        ...
                        <div class="thumb-wrapper">
                            ...
                            <div class="entry-header">
                              <span class="posted-in">
                                ...
                                <h2 class="entry-title"><a href="#">CTC to showcase technology solutions at Sea Air Space Exposition</a></h2>
                    ...
                    <article class="post-wrapper format-video">
                        ...
                        <div class="thumb-wrapper">
                            ...
                            <a class="external-link popup-video" href="https://www.youtube.com/watch?v=A1CoJKju-YI" title=""><i class="fa fa-play"></i></a>
                            ...
                            <div class="entry-header">
                              <span class="posted-in">
                                ...
                                <h2 class="entry-title"><a href="#">Master the psychology of web design</a></h2>
                    ...
                    <article class="post-wrapper format-quote">
                        ...
                        <div class="thumb-wrapper">
                            ...
                            <blockquote>
                                <p>A shopping cart flipped upside down forms a cage that I use to protect myself from consumerism</p>
                                <footer>Jarod Kintz</footer>
                            </blockquote>
